...
public class RemoveProductsFromCart extends TestBase {
	...
	@Test
	public void userCanPlaceOrderAndRegisterBeforeCheckout() {
		...
		wait.until(ExpectedConditions.visibilityOf(cartpage.emptymessage));
		assertTrue(cartpage.emptymessage.getText().contains("Cart is empty!"));
		System.out.println(cartpage.emptymessage.getText());
	}
}
