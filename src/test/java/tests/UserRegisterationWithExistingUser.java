...
public class UserRegisterationWithExistingUser extends TestBase {
	HomePage homepage;
	LoginOrSignupPage page;
	AccountInformationPage accountpage;
	MyAccountPage mypage;
	Faker faker=new Faker();
	String name="minatest6001";
	String email="minatest6001@gmail.com";
	...
	public void UserCanRegisterSuccessfully() {
		...
		System.out.println(driver.getCurrentUrl());
		page.userRegister(name, email);
		assertTrue(page.errormessage1.isDisplayed());
		System.out.println(page.errormessage1.getText());		
	}
}
